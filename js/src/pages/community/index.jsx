  ...
  return (
    <main className="container p-4 mx-auto mt-10">
      <section className="text-center">
        <h1 className="mb-4 text-4xl font-bold">멋사컴에 오신 것을 환영합니다!</h1>
        <p className="mb-6 text-xl">
          다양한 주제의 커뮤니티와 활발한 소통을 위한 플랫폼입니다. 관심사에 따라
          참여하고, 의견을 나누세요.
        </p>
        <a
          href="/"
      ...
      <section className="mt-16">
        <h2 className="mb-4 text-2xl font-bold text-center">주요 기능</h2>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
            <h3 className="mb-2 text-xl font-bold">정보 공유</h3>
          ...
          <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
            <h3 className="mb-2 text-xl font-bold">자유 게시판</h3>
          ...
          <div className="p-6 bg-white rounded shadow dark:bg-gray-800">
            <h3 className="mb-2 text-xl font-bold">질문 게시판</h3>
