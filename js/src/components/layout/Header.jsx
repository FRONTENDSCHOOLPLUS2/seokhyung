...
import { getImgFileApi } from '../../api/file/getImgFile';
import React, { useEffect, useState } from 'react';

const Header = () => {
  const { userNameGlobal, accessTokenGlobal, profileImgGlobal, userIdGlobal } =
    useUserStore();
  // useEffect(() => {
  //   if (accessTokenGlobal) {
  //     const res = getImgFileApi(profileImgGlobal);
